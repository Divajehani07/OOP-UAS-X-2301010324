...
public class formBuku extends javax.swing.JFrame {
    ...
    private void lsDtbuku() throws SQLException{
      ...
      if( !cnn.isClosed() ){
          ...
          while( rs.next() ){
              ...
              dta[1] = rs.getString("nama_buku");
               dta[2] = rs.getString("judul_buku");
              dta[3] = rs.getString("penulis");
    ...
    private void storeData() throws SQLException{
        Connection cnn = koneksi();
        if(!cnn.isClosed()){
            PreparedStatement ps = cnn.prepareStatement("INSERT INTO buku(id,nama_buku,judul_buku,penulis) VALUES(?,?,?,?);");
    ...
    private void updateData()throws SQLException{ 
        Connection cnn = koneksi();
        if(!cnn.isClosed()){
            PreparedStatement ps = cnn.prepareStatement("UPDATE buku SET nama_buku=?,judul_buku=?,penulis=? WHERE id=?;");
    ...
    private void destoryData()throws SQLException{
        Connection cnn = koneksi();
        if(!cnn.isClosed()){
            PreparedStatement ps = cnn.prepareStatement("DELETE FROM buku WHERE id=?;");
            ps.setString(1, txID.getText());
            ps.executeUpdate();
            cnn.close();
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("APLIKASI DATA BUKU");
